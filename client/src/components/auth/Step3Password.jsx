    ...
    <div className="space-y-5">
      ...
      <div className="flex gap-3">
        <button
          ...
          onClick={onBack}
          disabled={loading}
          className="flex-1 h-12 bg-white/5 border border-white/40 hover:bg-white/15 text-white font-semibold rounded-lg backdrop-blur-sm flex items-center justify-center gap-2 disabled:opacity-50"
        >
