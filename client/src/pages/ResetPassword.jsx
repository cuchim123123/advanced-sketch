...
export default function ResetPassword() {
  ...
  if (success) {
    return (
      <AuthLayout>
        <AuthCard>
          <AuthHeader title="Password Reset Complete" />
          ...
          <AuthContent>
            <div className="space-y-6">
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-white/80 text-sm [text-shadow:_0_1px_2px_rgb(0_0_0_/_30%)]">
      ...
      <AuthLayout>
        <AuthCard>
          ...
          <AuthFooter>
            ...
            <Link 
              to="/login" 
              className="block text-center text-white/80 hover:text-white text-sm transition [text-shadow:_0_1px_2px_rgb(0_0_0_/_40%)]"
            >
              Back to Login
            </Link>
          </AuthFooter>
  ...
  return (
    <AuthLayout>
      <AuthCard>
              ...
              <div className="space-y-2">
                ...
                {newPassword && passwordStrength && (
                  <div className="space-y-3 animate-in slide-in-from-top-2">
                    ...
                    <p className={`text-xs font-semibold [text-shadow:_0_1px_2px_rgb(0_0_0_/_40%)] ${
        ...
        <AuthFooter>
          <p className="text-center text-xs text-white/60 [text-shadow:_0_1px_2px_rgb(0_0_0_/_40%)]">
